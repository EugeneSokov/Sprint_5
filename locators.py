...
class Locators:
    ...
    REG_NAME = (By.XPATH, "//fieldset[1]/div/div/input") # Поле для ввода имени при регистрации
    REG_LINK = (By.XPATH, "//a[contains(text(),'Зарегистрироваться')]") # Активная ссылка "Зарегистрироваться"
    EMAIL_REG = (By.XPATH, "//fieldset[2]/div/div/input") # Поле ввода email на странице регистрации
    EMAIL_AUTOR = (By.XPATH, "//fieldset[1]/div/div/input") # Поле ввода email на странице авторизации
    PASS_REG = (By.XPATH, "//fieldset[3]/div/div/input") # Поле ввода пароля на странице регистрации
    REG_BUTTON = (By.XPATH, "//button[contains(text(),'Зарегистрироваться')]") # Кнопка "Зарегистрироваться"
    PASS_AUTOR = (By.XPATH, "//fieldset[2]/div/div/input") # Поле ввода пароля на странице авторизации
    ...
    ACTIVE_ELEM = (By.XPATH,"//div[@class = 'tab_tab__1SPyG tab_tab_type_current__2BEPc pt-4 pr-10 pb-4 pl-10 noselect']") # Активный раздел
